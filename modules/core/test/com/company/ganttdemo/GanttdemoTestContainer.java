...
public class GanttdemoTestContainer extends TestContainer {

    public GanttdemoTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/ganttdemo/app.properties",
    ...
    public static class Common extends GanttdemoTestContainer {

        public static final GanttdemoTestContainer.Common INSTANCE = new GanttdemoTestContainer.Common();
